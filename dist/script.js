    ...
    // Set up your HTML and write a JavaScript function that will render the contents of the gameboard 
    // array to the webpage (for now you can just manually fill in the array with "X"s and "O"s)
    ...
    // Think carefully about where each bit of logic should reside. Each little piece of functionality should be able to fit in the game, player 
    // or gameboard objects.. but take care to put them in “logical” places. Spending a little time brainstorming here can make your life much easier later!
